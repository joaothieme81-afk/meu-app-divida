...
e dos Gastos Públicos Federais, com base no artigo acadêmico do usuário.
...
def responder_pergunta(pergunta, df_evolucao, df_detentores, df_gastos):
    ...
    try:
        ...
        elif pergunta == "Qual foi o menor gasto (função) em 2018? (entre os listados)":
            df_2018 = df_gastos[df_gastos['ano'] == 2018]
        ...
        elif pergunta == "Qual foi o maior gasto (função) em 2024?":
        ...
        elif pergunta == "Qual o principal credor da Dívida Pública (foto recente)?":
        ...
        elif pergunta == "Qual foi o ano com o maior estoque da Dívida Pública (2018-2024)?":
        ...
        elif pergunta == "Qual foi o ano com o menor estoque da Dívida Pública (2018-2024)?":
...
if df_evolucao is not None and df_detentores is not None and df_gastos is not None:
    ...
    tab1, tab2, tab3, tab4 = st.tabs([
        ...
        "💡 Insights Interativos (Nova Função)"
    ])
    ...
    with tab4:
        ...
        lista_perguntas = [
            ...
            "Qual foi o maior gasto (função) em 2018?",
            "Qual foi o menor gasto (função) em 2018? (entre os listados)",
            "Qual foi o maior gasto (função) em 2024?",
            "Qual o principal credor da Dívida Pública (foto recente)?",
            "Qual foi o ano com o maior estoque da Dívida Pública (2018-2024)?",
            "Qual foi o ano com o menor estoque da Dívida Pública (2018-2024)?"
        ]
        ...
        if st.button("Buscar Resposta", type="primary"):
            if pergunta_selecionada != "Selecione uma pergunta...":
                ...
                st.warning("Por favor, selecione uma pergunta da lista.")
...
O objetivo é demonstrar as teses do artigo de forma visual e interativa, usando dados reais e condensados de fontes oficiais (Tesouro Nacional, Siga Brasil), mas carregados localmente para garantir estabilidade.
""")